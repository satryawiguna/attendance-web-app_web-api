              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <img src="{{asset('dasbor/img/logo.png')}}" style="max-width: 250px; margin-bottom: 20px">
                  </div>
                  @if ($errors->any())
                  ...
                  <form action="{{route('login')}}" method="post" class="user">
                    ...
                    <div class="form-group">
                      <input type="text" name="username" class="form-control form-control-user" placeholder="Username/Email" required>
                    </div>
                    <div class="form-group">
