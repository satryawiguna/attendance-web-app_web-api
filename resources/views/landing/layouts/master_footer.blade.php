...
<footer class="main-footer style-two">
  <div class="image-layer" style="background-image: url(landing/images/icons/footer-bg-2.png);"></div>
  <div class="container">
              ...
              <div class="row">
                  <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                      <div class="about-widget footer-widget">
                          <figure class="footer-logo"><a href="{{url('/')}}"><img src="{{asset('landing/images/logo-white.png')}}" alt=""></a></figure>
      ...
      <div class="footer-bottom">
          <div class="copyright">&copy; 2021 <a href="#">smartattendance</a>. All rights reserved</div>
      </div>
  </div>
</footer>
<!-- main-footer end -->